...
public interface DisputecaseRepository extends JpaRepository<Disputecase,String> {
     ...
     */
    /** 返回所有案件列表,4个查询条件 */
    @Query(value = "SELECT a.* from disputecase a inner join disputecase_process b on a.id=b.disputecase_id where b.status=?1 AND a.mediator_id=?2 AND a.apply_time >= ?3 AND a.apply_time<?4 ORDER BY ?#{#pageable},a.id DESC",
            countQuery = "SELECT count(*) from disputecase a inner join disputecase_process b on a.id=b.disputecase_id where b.status=?1 AND a.mediator_id=?2 AND a.apply_time >= ?3 AND a.apply_time<?4 ORDER BY a.id DESC",
            nativeQuery = true)
    ...
    /** 返回所有案件列表,1个查询条件 */
    @Query(value ="select a.* from disputecase a inner join disputecase_process b on a.id=b.disputecase_id where b.status=?1 ORDER BY ?#{#pageable},a.id DESC",
    ...
    @Query(value ="select a.* from disputecase a where a.mediator_id=?1 ORDER BY ?#{#pageable},a.id DESC",
            countQuery = "select count(*) from disputecase a where a.mediator_id=?1 ORDER BY a.apply_time DESC",
            nativeQuery = true)
    Page<Disputecase> findByMediatorId(String filterMediator,Pageable pageable);

    @Query(value = "SELECT a.* from disputecase a WHERE a.apply_time>=?1 ORDER BY ?#{#pageable},a.id DESC",
    ...
    /** 返回所有案件列表,2个查询条件 */
    @Query(value = "SELECT a.* from disputecase a inner join disputecase_process b on a.id=b.disputecase_id where b.status=?1 AND a.mediator_id=?2 ORDER BY ?#{#pageable},a.id DESC",
    ...
    @Query(value = "SELECT a.* from disputecase a inner join disputecase_process b on a.id=b.disputecase_id where b.status=?1 AND a.apply_time>=?2 ORDER BY ?#{#pageable},a.id DESC",
    ...
    @Query(value = "SELECT a.* from disputecase a where a.mediator_id=?1 AND a.apply_time>=?2 ORDER BY ?#{#pageable},a.id DESC",
    ...
    @Query(value = "SELECT a.* from disputecase a where a.apply_time>=?1 AND a.apply_time<?2 ORDER BY ?#{#pageable},a.id DESC",
    ...
    /** 返回所有案件列表,3个查询条件 */
    @Query(value = "SELECT a.* from disputecase a inner join disputecase_process b on a.id=b.disputecase_id where b.status=?1 AND a.mediator_id=?2 AND a.apply_time>=?3 ORDER BY ?#{#pageable},a.id DESC",
    ...
    @Query(value = "SELECT a.* from disputecase a inner join disputecase_process b on a.id=b.disputecase_id where b.status=?1 AND a.apply_time >= ?2 AND a.apply_time<?3 ORDER BY ?#{#pageable},a.id DESC",
            countQuery = "SELECT count(*) from disputecase a inner join disputecase_process b on a.id=b.disputecase_id where b.status=?1 AND a.apply_time >= ?2 AND a.apply_time<?3 ORDER BY ?#{#pageable} ORDER BY a.apply_time DESC",
            nativeQuery = true)
     ...
     */
    /** 获取所有案件 */
    @Query(value ="select a.* from disputecase a inner join disputecase_process b on a.id=b.disputecase_id where b.status='1' or b.status='0' or b.status='9' or b.status='10' or b.status='11' ORDER BY ?#{#pageable},a.id DESC",
    ...
    @Query(value ="select a.* from disputecase a inner join disputecase_process b on a.id=b.disputecase_id where b.status='1' or b.status='0' or b.status='9' ORDER BY ?#{#pageable},a.id DESC",
            countQuery = "select count(*) from disputecase a inner join disputecase_process b on a.id=b.disputecase_id where b.status='1' or b.status='0' or b.status='9' ORDER BY a.apply_time DESC",
            nativeQuery = true)
    ...
    @Query(value = "SELECT a.* from disputecase a inner join disputecase_process b on a.id=b.disputecase_id WHERE (b.status='1' or b.status='0' or b.status='9') and a.apply_time>=?1 ORDER BY ?#{#pageable},a.id DESC",
            countQuery = "SELECT count(*) from disputecase a inner join disputecase_process b on a.id=b.disputecase_id WHERE (b.status='1' or b.status='0' or b.status='9') and a.apply_time>=?1 ORDER BY a.apply_time DESC",
            nativeQuery =true )
    ...
    @Query(value = "SELECT a.* from disputecase a inner join disputecase_process b on a.id=b.disputecase_id where (b.status='1' or b.status='0' or b.status='9') and a.apply_time>=?1 AND a.apply_time<?2 ORDER BY ?#{#pageable},a.id DESC",
            countQuery = "SELECT count(*) from disputecase a inner join disputecase_process b on a.id=b.disputecase_id where (b.status='1' or b.status='0' or b.status='9') and a.apply_time>=?1 AND a.apply_time<?2 ORDER BY a.apply_time DESC",
            nativeQuery = true)
