...
public interface DisputecaseRepository extends JpaRepository<Disputecase,String> {
    ...
    @Query(value ="select a.* from disputecase a where a.mediator_id=?1 ORDER BY ?#{#pageable},a.apply_time DESC",
    ...
    @Query(value ="select a.* from disputecase a inner join disputecase_process b on a.id=b.disputecase_id where b.status='1' or b.status='0' or b.status='9' ORDER BY ?#{#pageable},a.apply_time DESC",
    ...
    @Query(value ="select a.* from disputecase a inner join disputecase_process b on a.id=b.disputecase_id where (b.status='1' or b.status='0' or b.status='9') and a.mediator_id=?1 ORDER BY ?#{#pageable},a.apply_time DESC",
    ...
    @Query(value = "SELECT a.* from disputecase a inner join disputecase_process b on a.id=b.disputecase_id WHERE (b.status='1' or b.status='0' or b.status='9') and a.apply_time>=?1 ORDER BY ?#{#pageable},a.apply_time DESC",
    ...
    @Query(value = "SELECT a.* from disputecase a inner join disputecase_process b on a.id=b.disputecase_id where (b.status='1' or b.status='0' or b.status='9') and a.mediator_id=?1 AND a.apply_time>=?2 ORDER BY ?#{#pageable},a.apply_time DESC",
    ...
    @Query(value = "SELECT a.* from disputecase a inner join disputecase_process b on a.id=b.disputecase_id where (b.status='1' or b.status='0' or b.status='9') and a.apply_time>=?1 AND a.apply_time<?2 ORDER BY ?#{#pageable},a.apply_time DESC",
    ...
    @Query(value = "SELECT a.* from disputecase a inner join disputecase_process b on a.id=b.disputecase_id WHERE (b.status='1' or b.status='0' or b.status='9') and a.mediator_id=?1 AND a.apply_time>=?2 AND a.apply_time<?3 ORDER BY ?#{#pageable},a.apply_time DESC",
